...
namespace NURU
{
    ...
    void Shader::Load(std::string name, std::string vsCode, std::string fsCode, std::vector<std::string> defines)
    {
        ...
        if (!status)
        {
            ...
            NURU_CORE_ERROR("Vertex shader compilation error at: {0}", name);
            NURU_CORE_ERROR(std::string(log));
        }
        glGetShaderiv(fs, GL_COMPILE_STATUS, &status);
        if (!status)
        {
            glGetShaderInfoLog(fs, 1024, NULL, log);
            NURU_CORE_ERROR("Fragment shader compilation error at: {0}", name);
            NURU_CORE_ERROR(std::string(log));
        }
        ...
        if (!status)
        {
            ...
            NURU_CORE_ERROR("Shader program linking error: {0}", std::string(log));
        }
    ...
    // --------------------------------------------------------------------------------------------
    void Shader::SetVector(std::string location, Vec2 value)
    {
        int loc = getUniformLocation(location);
        if (loc >= 0)
    ...
    // --------------------------------------------------------------------------------------------
    void Shader::SetVector(std::string location, Vec3 value)
    {
        int loc = getUniformLocation(location);
        if (loc >= 0)
    ...
    // --------------------------------------------------------------------------------------------
    void Shader::SetVector(std::string location, Vec4 value)
    {
        int loc = getUniformLocation(location);
        if (loc >= 0)
    ...
    // --------------------------------------------------------------------------------------------
    void Shader::SetVectorArray(std::string location, int size, const std::vector<Vec2>& values)
    {
    ...
    // --------------------------------------------------------------------------------------------
    void Shader::SetVectorArray(std::string location, int size, const std::vector<Vec3>& values)
    {
        unsigned int loc = glGetUniformLocation(ID, location.c_str());
        if (loc >= 0)
        {
    ...
    // --------------------------------------------------------------------------------------------
    void Shader::SetVectorArray(std::string location, int size, const std::vector<Vec4>& values)
    {
        unsigned int loc = glGetUniformLocation(ID, location.c_str());
        if (loc >= 0)
        {
    ...
    // --------------------------------------------------------------------------------------------
    void Shader::SetMatrix(std::string location, Mat2 value)
    {
        int loc = getUniformLocation(location);
        if (loc >= 0)
    ...
    // --------------------------------------------------------------------------------------------
    void Shader::SetMatrix(std::string location, Mat3 value)
    {
        int loc = getUniformLocation(location);
        if (loc >= 0)
    ...
    // --------------------------------------------------------------------------------------------
    void Shader::SetMatrix(std::string location, Mat4 value)
    {
        int loc = getUniformLocation(location);
        if (loc >= 0)
